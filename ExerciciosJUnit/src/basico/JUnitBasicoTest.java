 ...
 * 
 * Descomentar o teste, ver o teste falhar e fazer 
...
public class JUnitBasicoTest {
	...
	/*
	 * Quando numeros flutuantes sao comparados precisamos 
	 * definir o delta de diferenca nas casas decimais
	 * que podem acontecer.
	 * 
	 */
	...
	public void testCompareStrings() {
		...
		assertNotEquals("Hello World", whatToSay);
	}
